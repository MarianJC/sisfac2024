                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        {{ $categoria->caracteristica->estado == 1 ? '¿Seguro que deseas eliminar esta categoria?' : '¿Seguro que deseas restaurar esta categoria?' }}
                                    </div>
                                    <div class="modal-footer">
                                        ...
                                        <form action="{{ route('categorias.destroy',['categoria'=>$categoria->id]) }}" method="post">
                                            @method('DELETE')
                                            @csrf
                                            <button type="submit" class="btn btn-danger">Contfirmar</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
